...
1. One that's strictly bullet points explaining
what we achieved here, including all design constraints or otherwise
optimizations uncovered. X or fewer points. <br />
2. One that's two paragraphs
logically explaining the same (what we did here), but with greater attention to
detail and nuance with justifications for design decisions. Y paragraphs or
less.
