...
<ToggleDropdown title="I use this for every prompt">
  Before you do anything, tell me how my prompt could be improved. If you are
  unclear on task specifics, rather than do guesswork, ask me any clarifying
  questions to complete your understanding. Then do deep current research and
  thinking to complete your specific understanding of the task. Using your
  research, make an end-to-end, granular design implementation plan. Return this
  to me for approval before executing the task.
</ToggleDropdown>
...
used as a new prompt. I want future-proof closure of this chat. In the future, I
mainly want to save TIME and EFFORT on the errors, technicalities and details we
uncovered here with great time and effort. A data point from this chat should be
prioritized for the summary when it is:

1. Insights uncovered or researched through this chat which would be difficult
   to uncover WITHOUT repeating this chat. <br />
2. Prior-posterior beliefs about the system which have changed over the course
   of this chat, yielding a different understanding than when we began. <br />
3. (optional)Changes made to the code within this chat, as well as a short
   explanation for why each change was made. <br />

Do NOT include anything already included in the Documentation. Again, your goal
is to harvest & append insights that are HIGHLY UNIQUE, USEFUL, SPECIFIC, and
DIFFICULT TO UNCOVER and leave all else behind.

Your final briefing/summary/NewPrompt covering this chat should have two
sections:<br />

1. An outline in bullet points explaining what we achieved and learned here,
   including all design constraints or otherwise optimizations uncovered. Use
   plaintext formatting, and straightforward visual organization for this
   bullet-pointed outline. <br />
2. Two paragraphs logically explaining nuances of what we did/learned here,
   focusing on connecting reasoning logic to resulting actions taken, and
   justifications for design decisions in the final summary.
